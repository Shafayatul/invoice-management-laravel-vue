...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request) {
        if(Auth::user()->role == 'admin'){
            $expenses = Expense::with(['user', 'category', 'company'])->where('company_id', Auth::user()->company_id)->latest()->paginate($this->data_per_page);
        }else{
            $expenses = Expense::with(['user', 'category', 'company'])->latest()->paginate($this->data_per_page);
        }
